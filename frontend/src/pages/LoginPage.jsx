...
function GoogleSignInButton({ onSuccess, onError, loading }) {
  return (
    <div className="relative mx-auto w-full" style={{ maxWidth: '384px' }}>
      <button
        type="button"
        disabled={loading}
        className="pointer-events-none flex w-full items-center justify-center gap-3 rounded-full border border-white/12 bg-[#232428] px-4 py-3 text-sm font-medium text-white"
      >

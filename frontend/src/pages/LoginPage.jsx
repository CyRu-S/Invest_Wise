...
function GoogleSignInButton({ onSuccess, onError, loading }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="mx-auto flex w-full items-center justify-center gap-3 rounded-full border border-white/12 bg-[#232428] px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-[#2b2d31] disabled:cursor-not-allowed disabled:opacity-60"

...
function SkyToggle({
  ...
  const toggleSize = size === 'compact' ? '13px' : '18px';

  return (
    <StyledWrapper className={className} style={{ '--toggle-size': toggleSize }}>
...
const StyledWrapper = styled.div`
  .theme-switch {
    --toggle-size: var(--toggle-size, 30px);
    --container-width: 5.625em;
    --container-height: 2.5em;
    --container-radius: 6.25em;
    --container-light-bg: #7ec7ff;
    ...
    --transition: 0.55s cubic-bezier(0, -0.02, 0.4, 1.25);
    --circle-transition: 0.38s cubic-bezier(0, -0.02, 0.35, 1.17);
  ...
  .theme-switch__checkbox:focus-visible + .theme-switch__container {
    outline: 0.1em solid rgba(99, 102, 241, 0.42);

...
import { Sparkles, ArrowRight, TrendingUp, Shield, ChartBar, Wallet, CheckCircle2, Star, Zap, Globe, Users, Link as LinkIcon } from 'lucide-react'
    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-transparent text-foreground selection:bg-primary/20">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
                ...
                <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-accent/5 rounded-full blur-[120px] opacity-40" />
            </div>
            ...
            <section className="pt-32 pb-20 px-4 relative">
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-10 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                        FundSense helps you track your mutual funds, analyze risk, and discover top-performing opportunities using advanced AI algorithms.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                        <Link to="/register">
                            <Button size="lg" className="bg-primary hover:bg-primary/90 text-white px-8 h-14 text-lg rounded-full glow-blue transition-all hover:scale-105">
                                Start Investing Now
                                <ArrowRight className="w-5 h-5 ml-2" />
                            </Button>
                        </Link>
                        <Link to="/funds">
                            <Button size="lg" variant="outline" className="px-8 h-14 text-lg rounded-full border-primary/20 bg-background/50 backdrop-blur-sm hover:bg-primary/10 transition-all hover:scale-105">
                                Explore Funds
                            </Button>
                        </Link>
                    </div>
                            ...
                            <MagicGrid className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 w-full p-4 md:p-6 opacity-90 h-full items-center">
                                ...
                                <MagicCard className="glass-card p-6 rounded-xl border-white/5 bg-black/50 flex flex-col justify-between" enableStars={true}>
                                    <div className="flex justify-between items-start mb-4 relative z-10">
                                        <div>
                                            ...
                                            <h3 className="text-2xl font-bold text-white mt-1">$124,532.00</h3>
                                        </div>
                                ...
                                <MagicCard className="glass-card p-6 rounded-xl border-primary/20 bg-primary/5 transform md:scale-110 shadow-2xl shadow-primary/10 flex flex-col justify-between relative overflow-hidden" particleCount={30} enableStars={true}>
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-sm text-primary/80 font-medium mb-1">Available Balance</p>
                                        <h3 className="text-4xl font-bold text-white tracking-tight mb-2">$84,320.50</h3>
                                    ...
                                    <div className="relative z-10 mt-auto">
                                        <Button className="w-full bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/25 border border-white/10">
                                            Transfer Funds
                                        </Button>
                                    </div>
                                </MagicCard>
                                ...
                                <MagicCard className="glass-card p-6 rounded-xl border-white/5 bg-black/50" enableStars={true}>
                                    ...
                                    <div className="space-y-4 relative z-10">
                                        {[
                                            { name: "Netflix Sub", amount: "-$15.99", icon: "N", color: "bg-red-500" },
                                            { name: "Salary Deposit", amount: "+$4,250", icon: "$", color: "bg-green-500" },
                                            { name: "Spotify", amount: "-$9.99", icon: "S", color: "bg-green-400" },
                                        ].map((item, i) => (
            ...
            <section className="py-10 border-y border-white/5 bg-white/5 backdrop-blur-sm">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-sm font-medium text-muted-foreground mb-6 uppercase tracking-wider">Trusted by investors from top companies</p>
                    <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Logos would go here, using text placeholders for now with tech-y fonts */}
            ...
            <section className="py-24 px-4 relative">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6">How <span className="gradient-text">FundSense</span> Works</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                        ...
                        <div className="hidden md:block absolute top-12 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-transparent via-primary/50 to-transparent dashed-line -z-10" />

                        {[
                            { step: '01', title: 'Create Account', desc: 'Sign up in seconds and secure your profile.', icon: Users },
                            { step: '02', title: 'Connect Portfolio', desc: 'Sync your existing investments effortlessly.', icon: LinkIcon },
                            { step: '03', title: 'AI Analysis', desc: 'Our engine analyzes risk and opportunities.', icon: Zap },
                            { step: '04', title: 'Grow Wealth', desc: 'Act on insights and watch your portfolio grow.', icon: TrendingUp },
                        ].map((item, idx) => (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="space-y-6">
                                {[
                                    { title: 'AI-Driven Recommendations', desc: 'Personalized fund suggestions based on your unique risk profile.' },
                                    { title: 'Real-Time Portfolio Tracking', desc: 'Live updates on your asset allocation and performance metrics.' },
                                    { title: 'Smart Rebalancing', desc: 'Alerts when your portfolio drifts from your target allocation.' },
                                    { title: 'Tax-Saving Insights', desc: 'Optimize your returns with intelligent tax-harvesting suggestions.' }
                                ].map((feature, i) => (
                                ...
                                <div className="bg-black/80 rounded-xl p-6 md:p-8 space-y-6 relative z-10">
                                    ...
                                    <div className="flex justify-between items-end">
                                        <div>
                                            ...
                                            <h3 className="text-3xl font-bold text-white">$124,592.00</h3>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="p-4 rounded-lg bg-white/5">
                                            ...
                                            <p className="font-bold">Global 20%</p>
                                        </div>
                                    </div>
                                </div>
                            </MagicCard>
            ...
            <section className="py-24 px-4 overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    ...
                    <MagicGrid className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            { name: "Sarah J.", role: "Software Engineer", quote: "FundSense simplified my investment strategy completely. The AI insights are spot on!" },
                            { name: "Michael C.", role: "Small Business Owner", quote: "I finally understand where my money is going. The dashboard is intuitive and beautiful." },
                            { name: "Priya R.", role: "Product Manager", quote: "The best platform for tracking mutual funds I've used. Highly recommended!" }
                        ].map((testimonial, i) => (
                    ...
                    <MagicCard className="glass-card relative rounded-2xl p-8 md:p-12 text-center border-white/10 bg-black/40" enableStars={true} particleCount={20}>
                        <div className="relative z-10">
                            ...
                            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
                                Join thousands of investors who are taking control of their financial future with FundSense.
                            </p>
                            <div className="flex flex-col sm:flex-row justify-center gap-4">
                                <Link to="/register">
                                    <Button size="lg" className="bg-white text-black hover:bg-white/90 w-full sm:w-auto text-lg h-12">
                                        Create Free Account
                                    </Button>
                                </Link>
                                <Link to="/contact">
                                    <Button size="lg" variant="outline" className="w-full sm:w-auto text-lg h-12 border-white/20 hover:bg-white/10">
                                        Talk to Sales
                                    </Button>
                                </Link>
                            </div>
